        ...
        <div class="row mt-5 mt-md-4">
          <div class="col-9 col-md-6">
            <div>
              ...
              <form id="crearCategoria" action="">
                <input class="form-control form-control-lg rounded-pill" type="text" placeholder="Nombre de categoría">
              </form>
          ...
          <div class="col-3 col-md-2">
            <div class="d-flex align-items-end h-100">
              <a href="#"><button form="crearCategoria" type="submit" class="btn btn-primary"><span
        ...
        <div class="row mt-4">
          ...
          <div class="col-4 col-md-3 d-flex align-items-center">
            <div class="">
              ...
              <a class="ml-2" href=""><svg xmlns="http://www.w3.org/2000/svg" width="44.028" height="46.889"
                  viewBox="0 0 44.028 46.889">
                  <g id="Button" transform="translate(-850.386 -2499.575)">
                    <rect id="Background" width="44.028" height="46.889" rx="22" transform="translate(850.386 2499.575)"
                      fill="#e67161" />
