            ...
            <div class="col-md-9 p-3 p-md-5">
                ...
                <div class="row mt-4">
                    <div class="col-8 col-md-9">
                        <div class="d-flex align-items-center">
                            ...
                            <h5 class="text-bold text-marron-claro ml-3">Marketing Digital</h5>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-8 col-md-9">
                        <div class="d-flex align-items-center">
                            <img src="https://via.placeholder.com/75" alt="">
                            <h5 class="text-bold text-marron-claro ml-3">Pack de planners para organizar el día a día de
                                tu emprendimiento</h5>
                        </div>
                    </div>
                    <div class="col-4 col-md-3 d-flex align-items-center">
                        <div class="">
                ...
                <div class="row">
                    <div class="col-8 col-md-9">
                        <div class="d-flex align-items-center">
                            <img src="https://via.placeholder.com/75" alt="">
                            <h5 class="text-bold text-marron-claro ml-3">30 ideas de contenido para conectar con tu
                                público ideal</h5>
                        </div>
                    </div>
                    <div class="col-4 col-md-3 d-flex align-items-center">
